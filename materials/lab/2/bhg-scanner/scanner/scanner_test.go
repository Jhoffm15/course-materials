...
func TestOpenPort(t *testing.T){
    ...
    got,_ := PortScanner(24,1024) // Currently function returns only number of open ports
...
func TestTotalPortsScanned(t *testing.T){
    ...
    got,got2 := PortScanner(24,1024) // Currently function returns only number of open ports
